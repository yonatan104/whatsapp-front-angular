...
const CONTACTS = [
  {
    ...
    "laseMsg": "See u there",
    "lastMsgTimeStemp":"1656946455717"
  },
  {
...
export class ContactService {
  ...
  public query(filterBy: { term: string }): void {
    let contacts = this._contactsDb;
    if (filterBy && filterBy.term) {
      contacts = this._filter(contacts, filterBy.term)
    }
    console.log("🚀 ~ file: contact.service.ts ~ line 146 ~ ContactService ~ query ~ this._sort(contacts)", this._sort(contacts))
